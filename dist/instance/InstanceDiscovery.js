...
class InstanceDiscovery {
    ...
    getMetadataEntryAsync(authority, validateAuthority, requestContext) {
    ...
    discoverAsync(authority, validateAuthority, requestContext) {
        return __awaiter(this, void 0, void 0, function* () {
            const authorityHost = InstanceDiscovery.isWhitelisted(authority.host) ? InstanceDiscovery.getHost(authority) : InstanceDiscovery.defaultTrustedAuthority;
            ...
            try {
                const httpResponse = yield this.httpManager.sendGetAsync(instanceDiscoveryEndpoint, {}, requestContext);
            ...
            if (discoveryResponse && discoveryResponse.metadata) {
                for (const entry of discoveryResponse.metadata) {
                    for (const aliasedAuthority in entry.aliases) {
