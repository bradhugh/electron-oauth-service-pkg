...
class Utils {
    ...
    static async refreshAccessTokenAsync(url, authority, resource, clientId, resultEx, tokenCache, callState) {
    ...
    static async getAuthTokenInteractiveAsync(authority, authorizeUrl, accessTokenUrl, clientId, redirectUri, resourceId, tokenCache, callState) {
        const config = {
